...
Sistema de diseño de Sngular para presentaciones, sitios web y apps. Es la fuente única de color, tipografía, espaciado, logotipos, recursos gráficos y componentes. Se construyó a partir del **Brand Book Sngular 2025**, las plantillas **Guías y Modelos de Slides Editables 2025** y **sngular.com**. Todo lo que no viene de esas fuentes está marcado como *derivado para UI*.
